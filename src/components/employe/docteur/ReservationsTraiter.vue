  ...
  <div>
    ...
    >
      <template v-slot:item="{ item }">
        <ReservationItem :reservation="item" @clicked="traiter" traiter>
        </ReservationItem>
      </template>
    </v-data-table>
  </div>
...
export default {
  ...
  methods: {
    ...
    traiter(id) {
      this.$router.push("/employe/docteur/dashboard/traiter/" + id);
    },
  },
  created() {
...
{
  "fr": {
    "titre": "Réservation traiter",
    "search": "Rechercher"
  },
  "ar": {
    "titre": "الحجوزات المنتهية",
    "search": "بحث"
  }
}
</i18n>
