...
export default {
  ...
  mounted() {
    if (
      this.$route.path == "/employe/secretaire/dashboard" ||
      this.$route.path == "/employe/secretaire/dashboard/"
    ) {
      this.$router.push("/employe/secretaire/dashboard/accueil");
  ...
  methods: {
    ...
    changeActiveElement(element) {
      if (element === "deconnecter") {
        ...
        this.$router.push("/employe/secretaire/dashboard/" + element);
      }
    },
  },
};
